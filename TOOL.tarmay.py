...
def menu():
	...
	print(f'\x1b[1;93m1- CRACK BA FILE')
...
class D:
	...
	def plerr(self):
		...
		try:
			...
			fileX = input ('\x1b[1;93mNawi File : ')
...
def crack(idf,pwv):
	...
	sys.stdout.write(f"\r  TARMAY✔️  {P}{b}{loop}{P}•{b}{len(id)}{P}  • OK:{P}{H}{ok}{P} •  CP:{P}{M}{cp}{P} • ({bo}{'{:.0%})'.format(loop/float(len(id)))}  "),
	sys.stdout.flush()
